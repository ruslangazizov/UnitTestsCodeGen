...
final class TestFileManager {
    ...
    func createFile(fileName: String?, typeName: String) -> String? {
        ...
        if fileManager.createFile(atPath: testsFilePath, contents: nil) {
            self.className = className.split(separator: "/").last.map { String($0) }
    ...
    func generateFileContents(imports: [String],
        ...
        for data in unitTestDataArray {
            ...
            var shouldAddAdditionalEmptyLine = true
            if let arguments = data.arguments {
                ...
                if !arguments.isEmpty {
                    shouldAddAdditionalEmptyLine = false
                }
            }
            ...
            if shouldAddAdditionalEmptyLine {
    ...
    private func generateSetUpMethod(typeName: String,
                                     params: [SwiftMethodArgument]) -> [String] {
        var contents: [String] = []
    ...
    private func generateTearDownMethod(params: [SwiftMethodArgument]) -> [String] {
        var contents: [String] = []
